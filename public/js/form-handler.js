...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const alertMessages = {
    en: {
      missingFields:
        "Please fill in all the required fields so we can help you.",
      ...
      sendError:
        "We couldn't send your message right now. Could you try again?",
      networkError: "Connection issue",
      tryAgainLater: "Please try again in a little while.",
      invalidEmail: "Please enter a valid email address so we can reach you.",
      subscribing: "Adding you to our list...",
      subscribed: "You're on the list!",
      thankYouSubscribe: "Thank you for joining our community!",
      alreadySubscribed: "It looks like you're already subscribed. Thank you!",
      subscribeError: "We're having trouble subscribing you. Please try again.",
      confirmText: "Got it",
    },
    km: {
      missingFields: "សូមបំពេញព័ត៌មានដែលចាំបាច់ ដើម្បីឱ្យយើងអាចជួយអ្នកបាន។",
      sending: "កំពុងផ្ញើសាររបស់អ្នក...",
      pleaseWait: "សូមរង់ចាំមួយភ្លែត...",
      messageSent: "ទទួលបានសាររួចហើយ!",
      messageSuccess: "សូមអរគុណ! សាររបស់លោកអ្នកត្រូវបានផ្ញើដោយជោគជ័យ។",
      error: "សូមអភ័យទោស! មានបញ្ហាមួយបានកើតឡើង",
      sendError: "យើងមិនអាចផ្ញើសារបានទេនៅពេលនេះ។ សូមព្យាយាមម្ដងទៀត។",
      networkError: "មានបញ្ហាការភ្ជាប់បណ្ដាញ",
      tryAgainLater: "សូមមេត្តាព្យាយាមម្ដងទៀតនៅពេលក្រោយ។",
      invalidEmail: "សូមបញ្ចូលអាសយដ្ឋានអ៊ីមែលដែលត្រឹមត្រូវ។",
      subscribing: "កំពុងបញ្ចូលឈ្មោះរបស់អ្នក...",
      subscribed: "ការជាវបានសម្រេច!",
      thankYouSubscribe: "សូមអរគុណសម្រាប់ការចូលរួមជាមួយពួកយើង!",
      alreadySubscribed: "លោកអ្នកបានចុះឈ្មោះជាវរួចរាល់ហើយ។ សូមអរគុណ!",
      subscribeError: "មានបញ្ហាក្នុងការចុះឈ្មោះ។ សូមព្យាយាមម្ដងទៀត។",
      confirmText: "យល់ព្រម",
    },
  };
